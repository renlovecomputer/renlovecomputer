...
<table>
  <tr>
    ...
    <td width="60%" valign="top">
      ...
      <p>
        <code>💻 OS: Arch Linux</code> &nbsp; 
        <code>🦎 OS: Void Linux</code> &nbsp; 
        <code>🪟 OS: Windows 11 (Unactivated)</code>
      </p>
    ...
    <td width="40%" valign="top" align="center">
      <img src="https://githubusercontent.com" width="100%" style="border-radius: 8px;" />
    </td>
  </tr>
</table>
